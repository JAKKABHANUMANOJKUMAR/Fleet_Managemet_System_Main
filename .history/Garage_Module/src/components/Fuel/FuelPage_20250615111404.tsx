...
import { Fuel, Plus, X, Filter, IndianRupee, TrendingUp, TrendingDown, Truck, User } from 'lucide-react';
      ...
      render: (value: string, row: FuelEntry) => (
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">{row.vehicleId}</div>
          </div>
        </div>
      )
    },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 text-center ${
                        isDarkMode 
