...
export default function BranchFilter({ 
  ...
  // If user is operator, they can only see their assigned branch
  const availableBranches = userRole === 'operator' && userBranch
    ? branches.filter(b => b.id === userBranch)
    : branches;

  const canViewAllBranches = userRole === 'admin' || userRole === 'manager';
